...
if semne_aleatoare == True:
    print(f'Se transmite text cu {grupa} semne aleatoare. Pentru text predefinit seteaza variabila semne_aleatoare = False')
...
def transmisie():  # este definita functia transmisie
    ...
    for i in range(j):
        ...
        Beep(ton,
             int(cm[i]) * viteza2)  # fiecare element al valorii din variabila tip string cm este transformat in sunet
